...
export const metadata = {
  title: "About | Origin 54",
  description: "Rooted in Heritage - Discover the story behind Origin 54 and the Asili Collective.",
};
    ...
    <main className="min-h-screen bg-[var(--cream)] pt-32 pb-20 overflow-hidden">
      <section className="container mx-auto px-6 mb-32 relative">
        ...
        <div className="max-w-4xl">
          ...
          <p className="font-serif text-2xl md:text-3xl text-[var(--charcoal)]/80 italic leading-relaxed mb-12">
            &ldquo;Origin-54 was born from a singular vision: to bridge the gap between ancient African craftsmanship and modern global luxury.&rdquo;
          </p>
        </div>
      </section>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 font-serif text-[var(--cream)]/70 text-lg leading-relaxed">
              <p>
                ...
                vibrant cultures of each African nation.
              </p>
              <p>
                Asili means &ldquo;Origin&rdquo; or &ldquo;Nature&rdquo; in Swahili. We return to the source, 
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            { title: "Ethical Craft", desc: "We ensure fair wages and safe environments for every artisan in our collective." },
            { title: "Ancestral Tech", desc: "Preserving weaving and dyeing methods that pre-date modern machinery." },
            { title: "Modern Luxury", desc: "High-fashion silhouettes designed for the global trendsetter." }
          ].map((pillar, idx) => (
            <div key={pillar.title} className="border-t border-[var(--gold)]/30 pt-8">
      ...
      <section className="text-center py-32 border-t border-[var(--gold)]/10">
        ...
        <Link 
          href="/shop" 
          className="btn-gold px-16 py-5 inline-block font-display tracking-widest text-sm"
        >
          VIEW THE COLLECTION
        </Link>
      </section>
